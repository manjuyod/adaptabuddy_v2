...
This directory preserves completed historical specs that no longer belong in the active `specs/` queue.

Rules for this archive:
- Files here are historical records, not active work items.
- `specs/` is reserved for active engine-focused planning.
- The active roadmap index is `specs/overall_plan.md`.
...
- `engine_04_scoring_selection_and_decision_logs.md`
- `engine_05_testing_and_replay.md`
- `engine_06_isolated_engine_implementation.md`
- `engine_07_rust_review_fix_and_test_plan.md`
- `engine_08_initialize_cycle_boundary.md`
- `engine_09_cycle_generation_and_program_blending.md`
- `engine_10_engine_state_persistence_and_projection.md`
...
- `engine_18_deterministic_analytics_read_models.md`
- `engine_19_dashboard_analytics_consumer_migration.md`
- `engine_20_dashboard_remaining_analytics_read_models.md`
- `engine_21_analytics_api_endpoint.md`
- `engine_22_canonical_replay_serialization_and_numeric_policy.md`
- `engine_23_app_replay_invocation_alignment.md`
- `engine_24_replay_bundle_and_beta_debug_evidence.md`
- `engine_25_stats_json_compatibility_sunset_map.md`
