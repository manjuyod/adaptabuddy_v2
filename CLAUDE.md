...
This project is indexed by GitNexus as **adaptabuddy_v2** (6795 symbols, 11459 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
